...
function download_old_release() {
	if [ ! -f minio.RELEASE.2020-10-28T08-16-50Z ]; then
		curl --silent --max-time 300 -fL -o minio.RELEASE.2020-10-28T08-16-50Z https://github.com/minio/minio/releases/download/RELEASE.2020-10-28T08-16-50Z/minio.linux-amd64.RELEASE.2020-10-28T08-16-50Z
